// ==UserScript==
// @name         WINDOWS电脑 TikTok标签 v11.39 清理稳定版
// @name:zh-CN   WINDOWS电脑 TikTok标签 v11.39 清理稳定版
// @namespace    local-tiktok-label-printer-windows
// @version      11.39
// @description  v11.39：放大 50x30 标签二维码并调整右侧文字位置
// @description:zh-CN v11.39：放大 50x30 标签二维码并调整右侧文字位置
// @match        https://*/*
...
.qr{position:absolute;left:2.2mm;top:2mm;width:18mm;height:18mm;display:block;background:#fff;image-rendering:pixelated;image-rendering:crisp-edges;}
.row{position:absolute;overflow:hidden;text-align:left;font-weight:bold;line-height:1.08;}
.id{left:21.5mm;right:0.2mm;top:0.8mm;height:6mm;font-size:5.2pt;white-space:nowrap;}
.fullid{font-size:5.2pt;font-weight:bold;}
.last6inline{font-size:9.8pt;font-weight:900;}
.title{left:21.8mm;right:1.2mm;top:7mm;height:7.8mm;font-size:5.7pt;line-height:1.08;}
.time{left:21.8mm;right:1.2mm;top:15.5mm;height:4mm;font-size:6.2pt;white-space:nowrap;}
