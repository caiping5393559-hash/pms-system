// ==UserScript==
// @name         WINDOWS电脑 TikTok标签 v11.42 清理稳定版
// @name:zh-CN   WINDOWS电脑 TikTok标签 v11.42 清理稳定版
// @namespace    local-tiktok-label-printer-windows
// @version      11.42
// @description  v11.42：新增快捷打印今日 Auction/Giveaway，自动翻页到非当天订单并一次性按 Title 排序打印
// @description:zh-CN v11.42：新增快捷打印今日 Auction/Giveaway，自动翻页到非当天订单并一次性按 Title 排序打印
...
async function quickPrintTodayAuctionAndGiveaway(){
    ...
    try{
        ...
        updateStatus("快捷打印今日拍卖：扫描完成，准备按 Title 排序一次性打印 "+printable.length+" 单。停止原因："+(stopReason||"扫描结束")+"。");
        printLabelsBatch(printable,"快捷打印今日拍卖/Giveaway",{force:true});
    }catch(e){
