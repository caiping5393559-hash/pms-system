// ==UserScript==
// @name         WINDOWS电脑 TikTok标签 v11.51 清理稳定版
// @name:zh-CN   WINDOWS电脑 TikTok标签 v11.51 清理稳定版
// @namespace    local-tiktok-label-printer-windows
// @version      11.51
// @description  v11.51：快捷打印和复核改为安全采集；100/Page 且还有下一页时若采集数量不足会自动补扫，仍不足则停止并提示漏扫风险。
// @description:zh-CN v11.51：快捷打印和复核改为安全采集；100/Page 且还有下一页时若采集数量不足会自动补扫，仍不足则停止并提示漏扫风险。
