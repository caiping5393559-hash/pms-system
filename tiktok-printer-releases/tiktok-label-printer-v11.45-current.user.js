// ==UserScript==
// @name         WINDOWS电脑 TikTok标签 v11.45 清理稳定版
// @name:zh-CN   WINDOWS电脑 TikTok标签 v11.45 清理稳定版
// @namespace    local-tiktok-label-printer-windows
// @version      11.45
// @description  v11.45：修复本地扩展 CSP 拦截打印窗口内联脚本，打印按钮改由外层插件绑定
// @description:zh-CN v11.45：修复本地扩展 CSP 拦截打印窗口内联脚本，打印按钮改由外层插件绑定
...
.id{left:21.5mm;right:0.2mm;top:4.5mm;height:4.8mm;font-size:5.2pt;white-space:nowrap;}
.fullid{font-size:5.2pt;font-weight:bold;}
.last6inline{font-size:12.2pt;font-weight:900;}
.title{left:21.8mm;right:1.2mm;top:8.6mm;height:7mm;font-size:7.4pt;line-height:.9;}
.time{left:21.8mm;right:1.2mm;top:16.5mm;height:3.8mm;font-size:7.8pt;white-space:nowrap;}
