...
VERSION_NEW = "2026-06-23-ical-loop-guard-v1"
...
def main():
  ...
  setTimeout(bootFallback,120);"""
    ...
    new_import_guard = """        feed_marker = "generated by pms anti-overbooking feed"
        ...
        stable_id = hashlib.sha1((str(listing_id) + "|" + uid).encode("utf-8")).hexdigest()[:24]"""
    replace_any_once(app, [(old_import_guard, new_import_guard)], "self-generated feed import guard")
...
# deploy trigger: 2026-06-23-ical-loop-guard-v1
